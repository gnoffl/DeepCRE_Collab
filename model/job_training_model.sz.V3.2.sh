...
#$ -cwd 
############ change ######################
source /mnt/data/personal/simon/miniconda3/bin/activate
conda activate deepCREp3.7

python /mnt/data/personal/simon/projects/DeepCRE-git/DeepCRE/model/train_ssr_ssc_models_root.py
######
